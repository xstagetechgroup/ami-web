...
const Navbar: React.FC = () => {
    ...
    const events = pathname.includes('eventos');
        ...
        <div className='w-full bg-white shadow-md sticky top-0 left-0 z-50'>
            <Container>
                <div className='w-full flex justify-between items-center'>
                    <Link href={'/'}><Image src={'/assets/logo-horizontal.png'} alt='Logo' width={200} height={200} className='w-44 h-auto' /></Link>
                    ...
                    <ul className='hidden lg:flex font-semibold text-gray-700 flex-row items-center gap-10 text-base'>
                        ...
                        <li className={`hover:text-primaryColor duration-200 ${events && 'text-primaryColor'}`}><Link href={'/eventos'}>{t.navbar.events}</Link></li>
                ...
                {menuOpen && (
                    <ul className='lg:hidden flex flex-col gap-6 pb-6 text-center uppercase text-base'>
                        ...
                        <li><Link href={'/eventos'} onClick={toggleMenu} className={`hover:text-primaryColor duration-200 ${events && 'text-primaryColor'}`}>{t.navbar.events}</Link></li>
